...
data class ExtendedColors(
    ...
    val cardBackground: Color = cardSurface,
    val divider: Color = if (isDark) PaletteDark.Gray300 else PaletteLight.Gray200,
    val inputBackground: Color = if (isDark) PaletteDark.Gray100 else PaletteLight.Gray100,
...
val LocalExtendedColors = staticCompositionLocalOf {
    ExtendedColors(
        ...
        cardBackground = CardDarkSurface,
        divider = PaletteDark.Gray300,
        inputBackground = PaletteDark.Gray100,
